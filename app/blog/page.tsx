...
export const metadata: Metadata = {
  title: "Blog | Suhas Dhawale - Developer Stories & Insights",
  description:
    "Real stories, practical tips, and lessons learned from my journey as a full-stack developer and entrepreneur.",
  keywords: "web development blog, programming stories, developer journey, freelancing tips, React tutorials",
  openGraph: {
    title: "Blog | Suhas Dhawale",
    description: "Real stories, practical tips, and lessons learned from my journey as a full-stack developer.",
    type: "website",
  },
}
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900/50 pt-20">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/20 border border-white/30 mb-6">
            <span className="text-sm font-medium text-white">Personal Insights & Stories</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-zinc-900 dark:text-zinc-100 flex items-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {featuredPosts.map((post, index) => (
              <Card
                key={index}
                className="glass-effect hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 h-full border-2 border-orange-200 dark:border-orange-800"
              >
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  />
                  <Badge className="absolute top-4 left-4 bg-orange-500 text-white border-0">{post.category}</Badge>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {regularPosts.map((post, index) => (
              <Card
                key={index}
                className="glass-effect hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 h-full"
              >
                <div className="relative overflow-hidden rounded-t-lg">
                  <LazyImage
                    src={post.image}
